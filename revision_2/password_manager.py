...
def show_password_manager():
    ...
    passwords_db = ttk.Treeview(tree_frame, columns=("Title", "Email", "Username", "Password", "URL", "Notes"), show="headings", height=20) # Actual treeview
...
def close_pwmanager():
    # Closing password manager completely when window closed
    sys.exit()
